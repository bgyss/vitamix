...
/* TODO(Phase 2): 3-component formats (marked DEPRECATED below) are being phased out for Metal/Vulkan
 * compatibility. They have <5% hardware support on Vulkan vs >90% for 4-component equivalents.
 * Migration: Use SNORM_8_8_8_8 instead of SNORM_8_8_8, etc. See GPU_format_conversion.hh */
/* clang-format off */
...
#define SNORM_8_8_8_(impl)              impl(/*TODO*/,  1 * 3,  3,    SNORM_8_8_8,         R8G8B8_SNORM,         RGBA8Snorm,       Char3Normalized,     RGB8_SNORM,     rgb8_snorm)       /* DEPRECATED: Use SNORM_8_8_8_8 */
...
#define SNORM_16_16_16_(impl)           impl(/*TODO*/,  2 * 3,  3,    SNORM_16_16_16,      R16G16B16_SNORM,      RGBA16Snorm,      Short3Normalized,    RGB16_SNORM,    rgb16_snorm)    /* DEPRECATED: Use SNORM_16_16_16_16 */
...
#define UNORM_8_8_8_(impl)              impl(/*TODO*/,  1 * 3,  3,    UNORM_8_8_8,         R8G8B8_UNORM,         RGBA8Unorm,       UChar3Normalized,    RGB8,           rgb8_unorm)       /* DEPRECATED: Use UNORM_8_8_8_8 */
...
#define UNORM_16_16_16_(impl)           impl(/*TODO*/,  2 * 3,  3,    UNORM_16_16_16,      R16G16B16_UNORM,      RGBA16Unorm,      UShort3Normalized,   RGB16,          rgb16_unorm)     /* DEPRECATED: Use UNORM_16_16_16_16 */
...
#define SINT_8_8_8_(impl)               impl(char3,     1 * 3,  3,    SINT_8_8_8,          R8G8B8_SINT,          RGBA8Sint,        Char3,               RGB8I,          rgb8_sint)        /* DEPRECATED: Use SINT_8_8_8_8 */
...
#define SINT_16_16_16_(impl)            impl(short3,    2 * 3,  3,    SINT_16_16_16,       R16G16B16_SINT,       RGBA16Sint,       Short3,              RGB16I,         rgb16_sint)     /* DEPRECATED: Use SINT_16_16_16_16 */
...
#define SINT_32_32_32_(impl)            impl(int3,      4 * 3,  3,    SINT_32_32_32,       R32G32B32_SINT,       RGBA32Sint,       Int3,                RGB32I,         rgb32_sint)      /* DEPRECATED: Use SINT_32_32_32_32 */
...
#define UINT_8_8_8_(impl)               impl(uchar3,    1 * 3,  3,    UINT_8_8_8,          R8G8B8_UINT,          RGBA8Uint,        UChar3,              RGB8UI,         rgb8_uint)       /* DEPRECATED: Use UINT_8_8_8_8 */
...
#define UINT_16_16_16_(impl)            impl(ushort3,   2 * 3,  3,    UINT_16_16_16,       R16G16B16_UINT,       RGBA16Uint,       UShort3,             RGB16UI,        rgb16_uint)     /* DEPRECATED: Use UINT_16_16_16_16 */
...
#define UINT_32_32_32_(impl)            impl(uint3,     4 * 3,  3,    UINT_32_32_32,       R32G32B32_UINT,       RGBA32Uint,       UInt3,               RGB32UI,        rgb32_uint)      /* DEPRECATED: Use UINT_32_32_32_32 */
...
#define SFLOAT_16_16_16_(impl)          impl(/*TODO*/,  2 * 3,  3,    SFLOAT_16_16_16,     R16G16B16_SFLOAT,     RGBA16Float,      Half3,               RGB16F,         rgb16_sfloat)   /* DEPRECATED: Use SFLOAT_16_16_16_16 */
...
#define SFLOAT_32_32_32_(impl)          impl(float3,    4 * 3,  3,    SFLOAT_32_32_32,     R32G32B32_SFLOAT,     RGBA32Float,      Float3,              RGB32F,         rgb32_sfloat)   /* DEPRECATED: Use SFLOAT_32_32_32_32 */
...
#define SRGBA_8_8_8_(impl)              impl(/*TODO*/,  3,   3,    SRGBA_8_8_8,            R8G8B8_SRGB,              RGBA8Unorm_sRGB,       /* n/a */,             SRGB8,                               /* n/a */   )  /* DEPRECATED: Use SRGBA_8_8_8_8 */
/*                                           type       size comps blender_enum            vk_enum                   mtl_pixel_enum         mtl_vertex_enum        gl_pixel_enum                        shader_enum  */
